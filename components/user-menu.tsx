...
export function UserMenu() {
  ...
  if (!user) {
    return (
      <>
      <a target="_blank" className="flex flex-row items-center gap-2" href="https://github.com/Ebrahim-Ramadan/paste.me">
...
Github
      ...
      <Button onClick={handleSignIn} disabled={isSigningIn} size="sm ml-2">
